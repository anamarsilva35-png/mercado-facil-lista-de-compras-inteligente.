...
O controle das despesas de supermercado pode ser difícil quando os produtos são registrados de forma desorganizada e não há uma visão clara dos valores gastos por categoria. A aplicação tem como objetivo auxiliar pessoas e famílias no planejamento e controle das compras de mercado, permitindo registrar produtos, organizar os itens por categorias, acompanhar os valores e identificar produtos supérfluos que podem ser retirados da lista de compras. Dessa forma, a aplicação contribui para uma melhor organização das compras e para o controle dos gastos.
